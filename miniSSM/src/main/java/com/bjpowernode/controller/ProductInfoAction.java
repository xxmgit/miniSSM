...
public class ProductInfoAction {
    ...
    public Object ajaxImg(MultipartFile pimage,HttpServletRequest request) throws IOException {
        ...
        //转存
        pimage.transferTo(new File(path+File.separator + saveFileName));//File.separator是反斜杠

        //返回客户端JSON对象，封装图片的路径，在页面实现回显
    ...
    public String save(ProductInfo info ,HttpServletRequest request){
        ...
        //info对象中有表单提交上来的五个数据，有异步ajax上来的图片数据名称，有上架时间的数据
        ...
        //清空saveFileName变量中的内容，为了下次增加或者修改
        saveFileName = "";
    ...
    public String one(int pid,ProductInfoVo vo,Model model,HttpSession session){
        ...
        //将多条件及页码放入session中，更新处理结束后读取条件和页码进行处理读取条件和页码
    ...
    public String update(ProductInfo info ,HttpServletRequest request){
        ...
        //处理完更新后，saveFileName里可能有数据，所以清空
        saveFileName = "";
